...
// ---------------------------------------------------------------------
$jsver  = 32;   // bump to cache-bust local/sebkiosk/exam-ui.js
$jsurl  = '/local/sebkiosk/exam-ui.js?v=' . $jsver;   // root-relative: host-independent (localhost or a demo tunnel)
$footer = '<!-- sebkiosk -->'
  . '<style>'
