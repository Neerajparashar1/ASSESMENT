...
$string['st_intro'] = 'Upload a roster to create the student accounts and enrol them into this subject in one go. Add a "batch" column to also file each student into a batch (e.g. CS - A Batch 2024) - the batch is created if it does not exist.';
...
$string['st_done_msg'] = '{$a->created} new account(s) created, {$a->existing} already existed, {$a->enrolled} enrolled into this subject, {$a->batched} added to a batch.';
...
// ===== Batches (cohorts) =====
$string['b_title'] = 'Batches';
$string['b_intro'] = 'Group students into batches (e.g. "CS - A Batch 2024"), then enrol a whole batch into an exam course in one step instead of picking students one by one.';
$string['b_allbatches'] = 'All batches';
$string['b_new_h'] = 'New batch';
$string['b_name_ph'] = 'e.g. CS - A Batch 2024';
$string['b_code_ph'] = 'CSA2024';
$string['b_code_hint'] = 'The code is a short ID you can use in the "batch" column of a roster CSV. Leave it blank to auto-generate one from the name.';
$string['b_create'] = 'Create batch';
$string['b_created'] = 'Batch "{$a}" created.';
$string['b_all_h'] = 'All batches';
$string['b_name'] = 'Batch';
$string['b_code'] = 'Code';
$string['b_members'] = 'Students';
$string['b_syncs'] = 'Enrolled into';
$string['b_none'] = '—';
$string['b_manage'] = 'Manage';
$string['b_nobatches_yet'] = 'No batches yet. Create one above.';
$string['b_membercount'] = '{$a} student(s)';
$string['b_syncs_h'] = 'Courses this batch is enrolled into';
$string['b_nosyncs'] = 'Not enrolled into any course yet.';
$string['b_stopsync'] = 'Stop';
$string['b_unsynced'] = 'Course sync removed. Those students are no longer enrolled by this batch.';
$string['b_enrolinto_label'] = 'Enrol this batch into:';
$string['b_enrol_go'] = 'Enrol batch';
$string['b_enrolinto_course'] = 'Enrol a batch into {$a}';
$string['b_enrolled'] = 'Batch "{$a->batch}" is now enrolled into {$a->course}. New members will be enrolled automatically.';
$string['b_members_h'] = 'Students in this batch';
$string['b_nomembers'] = 'No students in this batch yet.';
$string['b_remove'] = 'Remove';
$string['b_removed'] = 'Student removed from the batch.';
$string['b_add_h'] = 'Add students';
$string['b_add_selected'] = 'Add selected to batch';
$string['b_added_n'] = '{$a} student(s) added to the batch.';
$string['b_bulk_h'] = 'Paste a list';
$string['b_bulk_hint'] = 'One username / roll number (or email) per line. Accounts must already exist - to create accounts and file them into a batch in one go, use "Add students" with a "batch" column in the CSV.';
$string['b_bulk_go'] = 'Add all to batch';
$string['b_bulk_result'] = 'Added {$a->added}, already in the batch {$a->already}, not found {$a->notfound}.';
$string['b_bulk_notfound_h'] = 'Not found - no account with that username or email';
$string['b_bulk_notfound_hint'] = 'Create these accounts first (Exam Wizard - Add students, or Bulk import users), then paste them again.';
$string['b_add_or_search'] = 'Or search for one student at a time:';
$string['b_delete'] = 'Delete this batch';
$string['b_delete_confirm'] = 'Delete this batch? Students stay, but they are removed from the batch.';
$string['b_deleted'] = 'Batch "{$a}" deleted.';
$string['b_err_noname'] = 'Give the batch a name.';
$string['b_err_dupcode'] = 'The code "{$a}" is already used by another batch.';
$string['b_err_hassyncs'] = 'Stop every course sync first, then delete the batch.';
$string['b_err_frontpage'] = 'That is the site front page, not an exam course - pick a real course to enrol a batch into.';
$string['qa_batches'] = 'Batches';
$string['w_batches'] = 'Batches sitting this exam';
$string['w_batches_help'] = 'Each batch you pick is enrolled into this course (as students) when the exam is published, so everyone in it can attempt. Leave empty to enrol students yourself.';
$string['w_rev_batches'] = 'Batches';
$string['w_wired_batches'] = 'Enrolled {$a} batch(es) into this course';
