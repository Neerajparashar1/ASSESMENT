...
class provider implements core_userlist_provider, metadata_provider, user_preference_provider {
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $submisionsfields = [
            ...
            'save_count' => 'privacy:metadata:vpl_submissions:save_count',
            'run_count' => 'privacy:metadata:vpl_submissions:run_count',
            'debug_count' => 'privacy:metadata:vpl_submissions:debug_count',
