 ...
 * @codeCoverageIgnore
 */
class similarity_php extends similarity_generic {
    /**
    ...
    /**
     * Constructor for the PHP similarity.
     */
     ...
     *   - Object/static access operators (->, ::) → dropped
