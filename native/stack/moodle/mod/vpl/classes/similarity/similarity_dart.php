...
/**
 * Dart language similarity class
 *
 * @package mod_vpl
 ...
 * @codeCoverageIgnore
 */
class similarity_dart extends similarity_generic {
    /**
    ...
    /**
     * Constructor for the Dart similarity.
     */
    public function __construct() {
        parent::__construct('dart');
    }
     ...
     *   - Null-aware assignment (??=) → expanded to "= ??"
     *   - Increment/decrement (++/--) → expanded to "= +"/"-"
     *   - Null-aware access (?.) dropped (noise like this. access)
            ...
            if ($token->type == token_type::OPERATOR) {
                ...
                switch ($token->value) {
                    ...
                    case ';':
                        ...
                        break;
                    case '?.':
                        // Null-aware access — same noise as this. access.
                        break;
                    case '.':
