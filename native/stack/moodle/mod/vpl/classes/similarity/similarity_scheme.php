 ...
 * @codeCoverageIgnore
 */
class similarity_scheme extends similarity_generic {
    /**
     * Constructor for the Scheme similarity.
     */
     ...
     *   - Conditional forms  cond / when / unless  → canonical "if"
     *   - Iteration forms   do  → canonical "while"
     *
        ...
        foreach ($tokens as $token) {
            if ($token->type == token_type::OPERATOR) {
                ...
                switch ($token->value) {
                    ...
                    case 'when':
                    case 'unless':
                        // Conditional forms → canonical "if".
                        $token->value = 'if';
                        break;
                    case 'do':
                        // Iteration form → canonical "while".
                        $token->value = 'while';
                        break;
                }
                $ret[] = $token;
