...
/**
 * Rust language similarity class
 *
 * @package mod_vpl
 ...
 * @codeCoverageIgnore
 */
class similarity_rust extends similarity_generic {
    /**
    ...
    /**
     * Constructor for the Rust similarity.
     */
     ...
     *   - "match" (pattern-match construct) → canonical "if"
     *
