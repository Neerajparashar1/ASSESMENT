...
/**
 * Lisp language similarity class
 *
 * @package mod_vpl
 ...
 * @codeCoverageIgnore
 */
class similarity_lisp extends similarity_generic {
    /**
     * Constructor for the Lisp similarity.
     */
    public function __construct() {
        parent::__construct('lisp');
    }

    /**
     * Normalizes the syntax of the given tokens.
     * Operator transformations:
     *   - Comparison aliases (eq → ==, neq → !=)
