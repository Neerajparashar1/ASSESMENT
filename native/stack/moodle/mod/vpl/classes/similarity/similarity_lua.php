 ...
 * @codeCoverageIgnore
 */
class similarity_lua extends similarity_generic {
    /**
     * Constructor for the Lua similarity.
     */
    public function __construct() {
        parent::__construct('lua');
    }
