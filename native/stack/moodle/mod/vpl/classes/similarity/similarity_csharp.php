 ...
 * @codeCoverageIgnore
 */
class similarity_csharp extends similarity_generic {
    /**
     ...
     *   - Null-coalescing assignment (??=) → expanded to "= ??"
     ...
     *   - Loop keywords  for / do / foreach  → canonical "while"
            ...
            if ($token->type == token_type::OPERATOR) {
                ...
                switch ($token->value) {
                    ...
                    case ';':
                        ...
                        break;
                    case '?.':
                        // Null-conditional operator — same noise as this. access.
                        break;
                    case '.':
