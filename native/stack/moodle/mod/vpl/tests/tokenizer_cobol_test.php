...
/**
 * Unit tests for the COBOL tokenizer.
 *
 * @package mod_vpl
 ...
 */
final class tokenizer_cobol_test extends \advanced_testcase {
    /**
     * Test that the COBOL tokenizer can parse a code example.
     *
    ...
    public function test_tokenizer_parse(): void {
       ...
       PROCEDURE DIVISION.
        ...
        $tokenizer = tokenizer_factory::get('cobol');
        $this->assertNotNull($tokenizer, 'Failed to create COBOL tokenizer');

        $tokens = $tokenizer->parse($code, false);
        $this->assertIsArray($tokens, 'Tokens should be an array');
        $this->assertNotEmpty($tokens, 'No tokens generated for COBOL');
        ...
        $this->assertTrue($found, 'COBOL tokenizer should produce at least one expected token type');
    }
