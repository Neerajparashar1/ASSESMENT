...
/**
 * Unit tests for the shell script tokenizer.
 *
 * @package mod_vpl
 ...
 */
final class tokenizer_shell_test extends \advanced_testcase {
    /**
     * Test that the shell tokenizer can parse a code example.
     *
...
';
        ...
        $tokenizer = tokenizer_factory::get('shell');
        $this->assertNotNull($tokenizer, 'Failed to create shell tokenizer');

        $tokens = $tokenizer->parse($code, false);
        $this->assertIsArray($tokens, 'Tokens should be an array');
        $this->assertNotEmpty($tokens, 'No tokens generated for shell');
        ...
        $this->assertTrue($found, 'Shell tokenizer should produce at least one expected token type');
    }
