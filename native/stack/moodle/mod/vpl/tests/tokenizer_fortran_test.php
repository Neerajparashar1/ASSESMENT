 ...
 */
final class tokenizer_fortran_test extends \advanced_testcase {
    /**
     * Test that the Fortran tokenizer can parse a code example.
     *
...
END FUNCTION factorial';
        ...
        $tokenizer = tokenizer_factory::get('fortran');
        $this->assertNotNull($tokenizer, 'Failed to create Fortran tokenizer');

        $tokens = $tokenizer->parse($code, false);
        $this->assertIsArray($tokens, 'Tokens should be an array');
        $this->assertNotEmpty($tokens, 'No tokens generated for Fortran');
        ...
        $this->assertTrue($found, 'Fortran tokenizer should produce at least one expected token type');
    }
