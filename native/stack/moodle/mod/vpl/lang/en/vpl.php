...
$string['open'] = 'Open';
$string['open_browser'] = 'Open in browser';
$string['open_private_browser'] = 'Open in private browser';
...
$string['privacy:metadata:vpl_ide_preferences'] = 'The user preferences for the IDE interface: theme, fontsize, etc.';
