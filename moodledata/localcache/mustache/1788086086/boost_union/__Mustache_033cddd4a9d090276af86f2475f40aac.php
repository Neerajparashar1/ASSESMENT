...
class __Mustache_033cddd4a9d090276af86f2475f40aac extends Mustache_Template
{
...
';
        $value = $context->find('showtitle');
        $buffer .= $this->section44cb1718862b1ea458a5597401bed9d9($context, $indent, $value);
        $buffer .= $indent . '
';
        $value = $context->find('hascontrols');
        $buffer .= $this->section33fdcc0503231c71488d986201bbd8e5($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section44cb1718862b1ea458a5597401bed9d9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <h3 id="instance-{{blockinstanceid}}-header" class="h5 card-title">{{{title}}}</h3>
            ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('blockinstanceid'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '-header" class="h5 card-title">';
                $value = $this->resolveValue($context->find('title'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '</h3>
';
    ...
    private function section33fdcc0503231c71488d986201bbd8e5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <div class="block-controls header ms-auto">
                    {{{controls}}}
                </div>
            ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <div class="block-controls header ms-auto">
';
                $buffer .= $indent . '                    ';
